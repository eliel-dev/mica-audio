...
4. `AudioMotion Clone` tambem usa `Frame128x64` no HUB75 para preservar paridade visual com o preview WinUI
...
- No HUB75, deixa de usar o fallback `Bins128` e passa a enviar o frame `128x64` completo.
- O objetivo passa a ser paridade visual com o preview, aceitando custo maior de transporte em troca de fidelidade.
