...
5. Para qualquer integracao do `ESP32-S3` neste repositorio, a IA deve consultar obrigatoriamente a documentacao oficial da Espressif compativel com `ESP-IDF v5.5.3` antes de decidir implementacao, configuracao ou recomendacao tecnica.
